    ...
    responseDataRegistrationState(Parcel p) {
        ...
        if (response.length == 6 && (response[3] != null) && Integer.parseInt(response[3]) == 14) {
            ...
            if (response[1] == null) { // TAC
                ...
                try {
                    response[6] = Integer.toString(Integer.parseInt(response[1]));
                } catch (NumberFormatException e) {
                    response[6] = Integer.toString(Integer.parseInt(response[1], 16));
                }
            }
            if (response[2] == null) { // ECI
                ...
                try {
                    response[8] =  Integer.toString(Integer.parseInt(response[2]));
                } catch (NumberFormatException e) {
                    response[8] = Integer.toString(Integer.parseInt(response[2], 16));
                }
            }
            // PCI, CSGID, and TADV
