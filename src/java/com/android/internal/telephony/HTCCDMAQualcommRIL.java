    ...
    responseVoiceRegistrationState(Parcel p) {
        ...
        if (response.length >6) {
            for (int i = 6; i <= 9; i++) {
             ...
             response = responseDataRegistrationState(p);
        }
    ...
    responseDataRegistrationState(Parcel p) {
        ...
        if (response.length <= 6 ) {
            ...
            if (response[1] == null) { // TAC
                ...
                try {
                    newResponse[6] = Integer.toString(Integer.parseInt(response[1]));
                } catch (NumberFormatException e) {
            ...
            if (response[2] == null) { // ECI
                ...
                try {
                    newResponse[8] =  Integer.toString(Integer.parseInt(response[2]));
                } catch (NumberFormatException e) {
