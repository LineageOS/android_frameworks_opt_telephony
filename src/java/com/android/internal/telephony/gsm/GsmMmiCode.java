...
public final class GsmMmiCode extends Handler implements MmiCode {
    ...
    static final String MMI_CODE_0_SUPPRESS_ERR = "0";
    static final String MMI_CODE_7_SUPPRESS_ERR = "7";
        ...
        switch (msg.what) {
            ...
            case EVENT_USSD_COMPLETE:
                ...
                if (ar.exception != null) {
                    mState = State.FAILED;
                    // suppress error pop-up for MMI code 0 and 7
                    if(mDialingNumber.equals(MMI_CODE_0_SUPPRESS_ERR) ||
                        mDialingNumber.equals(MMI_CODE_7_SUPPRESS_ERR)) {
                        Log.w(LOG_TAG, mContext.getText(com.android.internal.R.string.mmiError).toString());
                    } else {
