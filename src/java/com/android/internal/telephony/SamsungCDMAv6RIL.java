...
public class SamsungCDMAv6RIL extends RIL implements CommandsInterface {
    ...
    processSolicited (Parcel p) {
        ...
        Rlog.d(LOG_TAG, "Serial: " + serial);
        Rlog.d(LOG_TAG, "Error: " + error);
    ...
    responseCallList(Parcel p) {
        ...
        for (int i = 0 ; i < num ; i++) {
            ...
            Rlog.d(LOG_TAG, "numberPresentation = " + np);
    ...
    responseLastCallFailCause(Parcel p) {
        ...
        if (response.length > 0 &&
            ...
            Rlog.d(LOG_TAG, "Overriding ERROR_UNSPECIFIED fail cause with NORMAL_CLEARING.");
    ...
    responseSignalStrength(Parcel p) {
        ...
        if(response[2] > 95){
        //   Rlog.d(LOG_TAG, "SignalStrength: Scaling cdmaDbm \"" + response[2] + "\" for smaller SIGNAL_STRENGTH_POOR bucket.");
    ...
    responseSetupDataCall(Parcel p) {
        ...
        if (strings.length >= 2) {
            ...
            Rlog.d(LOG_TAG, "Set ril.cdma.data_state=0 to make sure pppd_cdma is stopped.");
    ...
    private boolean startPppdCdmaService(String ttyname) {
        ...
        Rlog.d(LOG_TAG, "Set ril.cdma.data_state=1, waiting for ril.cdma.data_state=2.");
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (SystemProperties.getInt("ril.cdma.data_state", 1) == 2) {
                Rlog.d(LOG_TAG, "Got ril.cdma.data_state=2, connected.");
                return true;
            }
        }
        ...
        Rlog.d(LOG_TAG, "Didn't get ril.cdma.data_state=2 timely, aborting.");
        SystemProperties.set("ril.cdma.data_state", "0");
    ...
    deactivateDataCall(int cid, int reason, Message result) {
        // Disconnect: Set ril.cdma.data_state=0 to stop pppd_cdma service.
        Rlog.d(LOG_TAG, "Set ril.cdma.data_state=0.");
        SystemProperties.set("ril.cdma.data_state", "0");
