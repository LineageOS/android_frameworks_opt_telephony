...
public class BlacklistUtils {
    ...
    public final static int BLOCK_CALLS = 1 << 0;
    public final static int BLOCK_MESSAGES = 1 << 1;
    ...
    public static boolean isBlacklistPrivateNumberEnabled(Context context) {
        return Settings.System.getIntForUser(context.getContentResolver(),
                Settings.System.PHONE_BLACKLIST_PRIVATE_NUMBER_ENABLED, 0,
                UserHandle.USER_CURRENT_OR_SELF) != 0;
    }

    public static boolean isBlacklistUnknownNumberEnabled(Context context) {
        return Settings.System.getIntForUser(context.getContentResolver(),
                Settings.System.PHONE_BLACKLIST_UNKNOWN_NUMBER_ENABLED, 0,
                UserHandle.USER_CURRENT_OR_SELF) != 0;
    }
