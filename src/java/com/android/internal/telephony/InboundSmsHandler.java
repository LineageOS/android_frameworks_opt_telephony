...
public abstract class InboundSmsHandler extends StateMachine {
    ...
    boolean processMessagePart(InboundSmsTracker tracker) {
        ...
        Intent intent;
        List<String> regAddresses = new ArrayList<String>();
        final String regAddressString = Settings.Secure.getString(mContext.getContentResolver(),
                Settings.Secure.PROTECTED_SMS_ADDRESSES);
        parseAndAddToList(regAddressString, regAddresses);
    ...
    private void parseAndAddToList(String baseString, List<String> list) {
        if (baseString == null) {
            return;
        }
