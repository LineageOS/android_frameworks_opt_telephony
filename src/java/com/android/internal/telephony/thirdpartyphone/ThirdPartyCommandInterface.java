...
/**
 * Third party phone doesn't need CommandsInterface. The class does nothing but made to work
 * with PhoneBase's constructor.
 */
class ThirdPartyCommandInterface extends BaseCommands implements CommandsInterface {
    ThirdPartyCommandInterface(Context context) {
        super(context);
    }
