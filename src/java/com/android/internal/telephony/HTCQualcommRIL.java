...
public class HTCQualcommRIL extends RIL implements CommandsInterface {
    ...
    public static final int RIL_UNSOL_ENTER_LPM = 1523;
    public static final int RIL_UNSOL_CDMA_3G_INDICATOR = 3009;
    public static final int RIL_UNSOL_CDMA_ENHANCE_ROAMING_INDICATOR = 3012;
    public static final int RIL_UNSOL_CDMA_NETWORK_BASE_PLUSCODE_DIAL = 3020;
    public static final int RIL_UNSOL_RESPONSE_PHONE_MODE_CHANGE = 6002;
    public static final int RIL_UNSOL_RESPONSE_VOICE_RADIO_TECH_CHANGED = 21004;
    public static final int RIL_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED = 21005;
    public static final int RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED = 21007;
