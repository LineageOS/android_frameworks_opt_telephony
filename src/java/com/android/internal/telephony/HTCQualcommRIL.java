...
public class HTCQualcommRIL extends RIL implements CommandsInterface {
    ...
    processUnsolicited (Parcel p) {
        ...
        switch(response) {
            ...
            case RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED_M7: ret = responseDataCallList(p);break;
            case RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED: ret = responseDataCallList(p);break;
