        ...
        if (isDsds && !isMultiRat && len > 1) {
            ...
            for (int phoneId = 0; phoneId < len; phoneId++) {
                ...
                if (id == subId) {
                    ...
                    phoneId1 = phoneId;
                    logdl("[setDefaultDataSubId] networkType1: " + networkType1 + ", phoneId1: " + phoneId1);
                } else {
                    networkType2 = PhoneFactory.calculatePreferredNetworkType(mContext, id);
                    phoneId2 = phoneId;
                    logdl("[setDefaultDataSubId] networkType2: " + networkType2 + ", phoneId2: " + phoneId2);
                }
            }
