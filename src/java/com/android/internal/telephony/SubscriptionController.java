            ...
            switch (msg.what) {
                case MESSAGE_SET_PREFERRED_NETWORK_TYPE: {
                    ...
                    if (ar.exception == null) {
                        ...
                        if (DBG) {
                            logd("[NetworkModeHandler] phoneId: " + phoneId + ", networkMode: "
                                    + networkMode + ", modemNetworkMode: " + modemNetworkMode);
                        }
                        if (modemNetworkMode != networkMode) {
                            Message msg2 = obtainMessage(MESSAGE_SET_PREFERRED_NETWORK_SETTING,
                                    phoneId, networkMode);
                            phone.setPreferredNetworkType(networkMode, msg2);
                        }
                    }
                    break;
                }
                case MESSAGE_SET_PREFERRED_NETWORK_SETTING: {
                    if (DBG) {
                        logd("[NetworkModeHandler] phoneId: " + phoneId
