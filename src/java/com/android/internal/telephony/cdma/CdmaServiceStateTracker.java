...
public class CdmaServiceStateTracker extends ServiceStateTracker {
    ...
    protected void updateSpnDisplay() {
        ...
        if (combinedRegState == ServiceState.STATE_OUT_OF_SERVICE) {
            ...
            showPlmn = ( !TextUtils.isEmpty(plmn)) && ((rule & RuimRecords.SPN_RULE_SHOW_PLMN) == RuimRecords.SPN_RULE_SHOW_PLMN);
            spn = (mIccRecords != null) ? mIccRecords.getServiceProviderName() : "";
            showSpn = (!TextUtils.isEmpty(spn)) && ((rule & RuimRecords.SPN_RULE_SHOW_SPN) == RuimRecords.SPN_RULE_SHOW_SPN);
        } else {
