...
public class CdmaServiceStateTracker extends ServiceStateTracker {
    ...
    protected void updateSpnDisplay() {
        ...
        if (combinedRegState == ServiceState.STATE_OUT_OF_SERVICE) {
            ...
            //If the entry exists, the lookup returns the mapped spn name, otherwise returns the originally provide numeric
            ...
            if (isValidOpNumeric && (TextUtils.isEmpty(mSS.getOperatorAlphaLong())
                ...
                // If modem reports a valid numeric, but the operator name is not set or erroneously set to numeric, override
                plmn = spnOverride;
            } else if (isInHomeList(opNumArray, ruimNumeric) || isInHomeList(opNumArray, mSS.getOperatorNumeric())
                ...
                // -modem reported numeric is the same as the primary home numeric property (this is for backwards compatible)
