        ...
        if (mSprintMwiQuirk) {
            ...
            if (address != null && address.equals("9016")) {
                ...
                if (message != null) {
                    ...
                    // which is followed by a space that we trim off
                    ...
                    // This is always followed by a comma
