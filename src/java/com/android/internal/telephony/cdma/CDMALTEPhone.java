...
public class CDMALTEPhone extends CDMAPhone {
    ...
    public String getSubscriberId() {
        ...
        if (TextUtils.isEmpty(imsi)) {
            if (mUiccController.getUiccCard() != null) {
                ...
                log("null getUiccCard in getSubscriberId");
            }
        }
    ...
    protected void onUpdateIccAvailability() {
        ...
        UiccCard card = mUiccController.getUiccCard(mPhoneId);
        if (card != null) {
            int count = card.getNumApplications();
