...
public class SIMRecords extends IccRecords {
    ...
    public SIMRecords(UiccCardApplication app, Context c, CommandsInterface ci, UICCConfig uC) {
        super(app, c, ci, uC);
    ...
    protected void resetRecords() {
        ...
        mUCCConfig.setImsi(mImsi);
        mUCCConfig.setMncLength(mMncLength);
