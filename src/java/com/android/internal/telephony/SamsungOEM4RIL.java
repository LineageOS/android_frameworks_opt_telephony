...
public class SamsungOEM4RIL extends RIL implements CommandsInterface {
    ...
    protected HandlerThread mSamsungOEM4RILThread;
    protected ConnectivityHandler mSamsungOEM4RILHandler;
    private AudioManager audioManager;
    private boolean mIsGBModem = SystemProperties.getBoolean("ro.ril.gbmodem", false);

    public SamsungOEM4RIL(Context context, int networkMode, int cdmaSubscription) {
    ...
    public void setPreferredNetworkType(int networkType , Message response) {
        ...
        if(NeedReconnect())
        {
            if (mSamsungOEM4RILHandler == null) {

                handlerThread = new HandlerThread("mSamsungOEM4RILThread");
                mSamsungOEM4RILThread = handlerThread;

                mSamsungOEM4RILThread.start();

                looper = mSamsungOEM4RILThread.getLooper();
                mSamsungOEM4RILHandler = new ConnectivityHandler(mContext, looper);
            }
            mSamsungOEM4RILHandler.setPreferedNetworkType(networkType, response);
        } else {
            if (mSamsungOEM4RILHandler != null) {
                mSamsungOEM4RILThread = null;
                mSamsungOEM4RILHandler = null;
            }
