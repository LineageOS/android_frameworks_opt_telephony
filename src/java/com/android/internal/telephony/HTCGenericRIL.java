...
/**
 * Generic HTC RIL class 
 *
 * {@hide}
 */
public class HTCGenericRIL extends RIL implements CommandsInterface {

    private static final int RIL_UNSOL_UNKNOWN_1 = 1550;
    private Object mCatProCmdBuffer;
    
    public HTCGenericRIL(Context context, int networkMode, int cdmaSubscription) {
    ...
    processUnsolicited (Parcel p) {
        ...
        switch(response) {
            case RIL_UNSOL_UNKNOWN_1: ret = responseString(p); break;
